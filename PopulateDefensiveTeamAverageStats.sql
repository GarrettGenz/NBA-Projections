DELETE FROM defensive_team_average_stats;

INSERT INTO defensive_team_average_stats
SELECT ttd.gameid,
      ttd.home_or_away,
  ttd.team,
  ...
  ttd.prev_gameid
   FROM ((team_training_data ttd
     ...
     JOIN offensive_team_stats ops ON (((ops.team_abbrev = opp.opp_team) AND (ops.gameid = opp.gameid))))
